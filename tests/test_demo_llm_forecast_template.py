...
""",
    ...
    monkeypatch.setattr(template_script, "CLYFAR_VERSION", "1.0.2")
    monkeypatch.setattr(template_script, "FFION_VERSION", "1.1.1")
    ...
    assert "- Clyfar version: `1.0.2`" in output
    assert "- Ffion version: `1.1.1`" in output
    ...
    assert "Forecaster: Ffion v1.1.1 and Clyfar v1.0.2" in output
