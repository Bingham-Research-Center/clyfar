...
> - Forecaster: **Ffion v1.1.2** (ffion@jrl.ac), using **Clyfar v1.0.4** and GEFS ensemble inputs.
---
...
def test_validate_outlook_fails_on_version_mismatch(tmp_path):
    ...
    ok, errors = validate_outlook(outlook, expected_clyfar="1.0.5", expected_ffion="1.1.2")
    assert not ok
