...
- `docs/archive/root_notes/LLM-SOP.md` - Standard operating procedures
...
- `docs/archive/root_notes/LLM-SOP.md` - LLM generation procedures
...
| `docs/archive/root_notes/LLM-SOP.md` | New: standard operating procedures |
...
| Documentation | ~20 | CLAUDE.md, docs/archive/root_notes/LLM-SOP.md, README |
