...
The active prompt-science bundle is {{FFION_SCIENCE_VERSION}} ({{FFION_SCIENCE_LABEL}}).
...
> - Forecaster: **Ffion v{{FFION_VERSION}}** (ffion@jrl.ac), using **Clyfar v{{CLYFAR_VERSION}}** and GEFS ensemble inputs.
> - Prompt science: **Ffion Science v{{FFION_SCIENCE_VERSION}}** ({{FFION_SCIENCE_LABEL}})
